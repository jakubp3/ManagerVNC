  ...
  if (sessions.length === 0) {
    return (
      <div className="flex-1 flex items-center justify-center bg-gray-100 dark:bg-gray-900">
        <div className="text-gray-500 dark:text-gray-400 text-lg">No VNC sessions open</div>
      </div>
    );
  }

  return (
    <div ref={containerRef} className={`vnc-tabs-container flex-1 flex flex-col min-h-0 ${isFullscreen ? 'fixed inset-0 z-50 bg-white dark:bg-gray-900' : ''}`}>
      {/* Tab bar - always visible, even in fullscreen */}
      <div className="bg-gray-200 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700 flex overflow-x-auto flex-shrink-0 items-center h-12">
